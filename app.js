...
//   function fetchMovies(url, dom_element, path_type) {
    fetch('https://api.themoviedb.org/3/discover/tv?api_key=19f84e11932abbc79e6d83f82d6d1045&with_networks=213').then(response => response.json()).then(json => console.log(json))
